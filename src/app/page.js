...
export default function CadastroPage() {
  function cadastrar(imovel) {
    // Recebo os dados do imovel do formulário
    console.log(imovel);
    // Busco no localStorage a lista de imovel, se não existir crio uma nova vazia
    const imoveis = JSON.parse(localStorage.getItem("imoveis")) || [];
    // Acrescento o novo imovel na lista
    imoveis.push(imovel);
    // Gravar a nova lista de imovel no localStorage, substituindo a antiga
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group as={Col}>
              ...
              <Form.Control
                name="foto"
                type="text"
                placeholder="coloque uma foto do local"
                value={values.foto}
                onChange={handleChange}
                onBlur={handleBlur}
            ...
            <Form.Group className="py-3" as={Col}>
              ...
              <Form.Control
                ...
                name="descricao"
                type="text"
                placeholder="Descrição breve do imóvel destacando seus principais atributos."
